...
datos.Sueldo('nombres', 'sueldo base', 'año de ingreso', 'horas extra', 276.5)
datos.empleado_MA('año de ingreso', 'nombres', 'paterno')
datos.empleado_MR('año de ingreso', 'nombres', 'paterno')